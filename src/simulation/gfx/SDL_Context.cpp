...
void SDL_Context::DrawRect(int x, int y, int w, int h) {
    ...
    SDL_Rect rect = {x + static_cast<int>( this->fTranslate.GetX()), y + static_cast<int>(this->fTranslate.GetY()), w,
                     h};
...
void SDL_Context::DrawRect(const Vec2 &pos, const Vec2 &size) {
    ...
    SDL_Rect rect = {static_cast<int>(this->pos.GetX()),
                     static_cast<int>(this->pos.GetY()),
